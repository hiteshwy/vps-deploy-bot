...
@app_commands.describe(
    ...
    ram="Amount of RAM (e.g., 512m, 1g, 2g)"
)
async def deploy(interaction: discord.Interaction, user: discord.User, os: str, ram: str):
    try:
        ...
        try:  
            ...
            container_id = subprocess.check_output(
                ["docker", "run", "-itd", "--privileged", f"--memory={ram}", os_data["image"]]
            ).strip().decode('utf-8')  
